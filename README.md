# Archived!
This repository is no longer in use. The opendata.slo.nl system now uses the [slonl/curriculum-store]([https:/github.com/slonl/curriculum-store](https://github.com/slonl/curriculum-store), based on [SimplyStore](https://github.com/SimplyEdit/SimplyStore.git), as a backend.
